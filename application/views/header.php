...
echo "<script type=text/javascript src='".base_url('assets/header.css')."'></script>";

echo "<script type=text/javascript src='".base_url('assets/bootstrap/css/bootstrap.min.js')."'></script>";
echo "<script type=text/javascript src='".base_url('assets/header.js')."'></script>";
?>
